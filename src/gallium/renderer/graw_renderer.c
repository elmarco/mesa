...
static struct {
   ...
   GLenum glformat;
   GLenum gltype;
} tex_conv_table[VIRGL_FORMAT_MAX] =
   {
      [VIRGL_FORMAT_B8G8R8X8_UNORM] = {GL_RGBA8, GL_BGRA, GL_UNSIGNED_BYTE },
      [VIRGL_FORMAT_B8G8R8A8_UNORM] = {GL_RGBA8, GL_BGRA, GL_UNSIGNED_BYTE },

      [VIRGL_FORMAT_R8G8B8A8_UNORM] = {GL_RGBA8, GL_RGBA, GL_UNSIGNED_BYTE },
      [VIRGL_FORMAT_R8G8B8X8_UNORM] = {GL_RGBA8, GL_RGBA, GL_UNSIGNED_BYTE },

      [VIRGL_FORMAT_A8R8G8B8_UNORM] = {GL_RGBA8, GL_BGRA, GL_UNSIGNED_INT_8_8_8_8_REV },
      [VIRGL_FORMAT_X8R8G8B8_UNORM] = {GL_RGBA8, GL_BGRA, GL_UNSIGNED_INT_8_8_8_8_REV },

      [VIRGL_FORMAT_A8B8G8R8_UNORM] = {GL_ABGR_EXT, GL_RGBA, GL_UNSIGNED_BYTE },
      [VIRGL_FORMAT_B5G6R5_UNORM] = {GL_RGB4, GL_RGBA, GL_UNSIGNED_SHORT_5_6_5 },

      [VIRGL_FORMAT_B4G4R4A4_UNORM] = {GL_RGBA4, GL_RGBA, GL_UNSIGNED_SHORT_4_4_4_4 },

      [VIRGL_FORMAT_S8_UINT] = {GL_DEPTH24_STENCIL8_EXT, GL_DEPTH_STENCIL, GL_UNSIGNED_BYTE},
      [VIRGL_FORMAT_Z16_UNORM] = {GL_DEPTH_COMPONENT16, GL_DEPTH_COMPONENT, GL_UNSIGNED_SHORT},

      [VIRGL_FORMAT_Z24_UNORM_S8_UINT] = {GL_DEPTH24_STENCIL8_EXT, GL_DEPTH_STENCIL, GL_UNSIGNED_INT_24_8},

//      [VIRGL_FORMAT_S8_UINT_Z24_UNORM] = {GL_DEPTH24_STENCIL8_EXT, GL_DEPTH_STENCIL, GL_UNSIGNED_INT_24_8},
      [VIRGL_FORMAT_Z24X8_UNORM] = {GL_DEPTH_COMPONENT24, GL_DEPTH_COMPONENT, GL_UNSIGNED_INT},
      [VIRGL_FORMAT_Z32_UNORM] = {GL_DEPTH_COMPONENT32, GL_DEPTH_COMPONENT, GL_UNSIGNED_INT},
