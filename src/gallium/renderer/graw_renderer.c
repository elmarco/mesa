...
static struct {
...
} tex_conv_table[PIPE_FORMAT_COUNT] =
   {
      ...
      [PIPE_FORMAT_A16_FLOAT] = {GL_ALPHA16F_ARB, GL_ALPHA, GL_FLOAT },
      [PIPE_FORMAT_R16_FLOAT] = {GL_R16F, GL_RED, GL_FLOAT },
      [PIPE_FORMAT_R16G16_FLOAT] = {GL_RG16F, GL_RG, GL_FLOAT },
      [PIPE_FORMAT_R16G16B16_FLOAT] = {GL_RGB16F, GL_RGB, GL_FLOAT },
      [PIPE_FORMAT_R16G16B16A16_FLOAT] = {GL_RGBA16F, GL_RGBA, GL_FLOAT },
